...
+ (NSURL *)URLforRecentGeoreferencedPhotos:(int)maxResults;
{
    return [self URLForQuery:[NSString stringWithFormat:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&license=1,2,4,7&has_geo=1&per_page=%d&extras=original_format,description,geo,date_upload,owner_name", maxResults]];
}
